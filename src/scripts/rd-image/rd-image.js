...
export class RdImageBlot extends BlockEmbed {
    ...
    static create(id) {
       let node = super.create();
        node.dataset.id = id;
        node._removeButton = buildBlockControlElements(node);
        node._editForm = imageInput.createImageInput(node);
        node._imageElm = buildImgElement(node);
        node.appendChild(node._imageElm);
        node._imageElm.appendChild(node._removeButton);
